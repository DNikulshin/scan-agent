...
export const config = {
  ...
  filter: {
    ...
    stopWords: [
      'отзыв', 'реферат', 'диплом', 'курсовая',
      'перевод', 'копирайт', 'текст', 'рерайт',
      'seo текст', 'статья', 'контент-план',
    ],
  ...
  fl: {
    ...
    selectors: {
      ...
      description: '[data-qa="project-item-description"], .b-post__body, .b-post__txt',
